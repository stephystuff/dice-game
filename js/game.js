(function diceGame() {
  ...
  document.querySelector('.game-start').innerText = "Game started " + diceGame.startDate.getFullYear() + " " + (diceGame.startDate.getMonth()+1) + " " + diceGame.startDate.getDate() + " " + "at " + diceGame.startDate.getHours() + ":" + diceGame.startDate.getMinutes();
})();
